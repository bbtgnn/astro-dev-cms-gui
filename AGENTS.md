...
**dev-mode route** inside an Astro project. Optional overlay (form tree + direct Svelte
...
- **Blocks / preview:** block schemas stay separate from production renderers; the real Astro page is the default preview (ADR-0012, 0013). Revive blocks/i18n as stamp/form-tree kinds ([#29](https://github.com/bbtgnn/astro-dev-cms-gui/issues/29)), not Zod FieldUi.
