...
- **Install surface:** convention-first `cms()` — `src/cms.config.ts` + generated `src/content.config.ts` + `src/content/` (ADR-0016, 0019). Default host is built by `@cms/astro` from the schema partition.
